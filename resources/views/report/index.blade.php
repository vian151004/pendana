...
<div class="row">
    <div class="col-lg-12">
        <x-card>
            <x-slot name="header">
                <div class="btn-group">
                    <button data-toggle="modal" data-target="#modal-form" class="btn btn-primary rounded"><i class="fas fa-pencil-alt"></i> Ubah Periode</button>
                    <a target="_blank" href="{{ route('report.export_pdf', compact('start', 'end')) }}" class="btn btn-danger mx-3 rounded"><i class="fas fa-file-pdf"></i>Export PDF</a>
                    <a target="_blank" href="{{ route('report.export_excel', compact('start', 'end')) }}" class="btn btn-success rounded"><i class="fas fa-file-excel"></i>Export Excel</a>
                </div>
            </x-slot>
