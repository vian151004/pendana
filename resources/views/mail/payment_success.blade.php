            ...
            <div class="card shadow-none mt-3 mx-2 mt-lg-0">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div class="logo my-4">
                            <img src="{{ asset('storage'.($setting->path_image ?? '#')) }}" alt="logo" height="120">
                        </div>
                    </div>

                    <div>
                        <p class="text-center mt-3 mt-lg-4">
                            Terimakasih {{ $donation->user->name }}, Admin akan segera memproses pembayaran Anda.
                        </p>
                        ...
                        <table class="table table-sm table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>: 
                                        @if (asset('storage'.($donation->payment->path_image)))
