                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-lg-8 mx-auto">
                            <a href="{{ url('/') }}">
                                <img src="{{ asset('/storage/logo.png') }}" alt="" class="w-50 mb-4">
                            </a>
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group d-flex justify-content-between aign-items-center mb-3">
                                ...
                                <div class="text-center mt-3">
                                    <div class="text-muted">Jika belum punya akun, silahkan registrasi
                                        <a href="{{ route('register') }}" class="">disini!</a>
                                    </div>
                                </div>
                            </form>
                        </div>
