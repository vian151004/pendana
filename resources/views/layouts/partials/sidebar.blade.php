...
<aside class="main-sidebar sidebar-dark-lightblue elevation-4">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link bg-lightblue">
        <img src="{{ asset('storage'. ($setting->path_image ?? '')) }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('storage'. (auth()->user()->path_image ?? '')) }}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
