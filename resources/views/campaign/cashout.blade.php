    ...
    <div class="col-7">
        ...
        <x-card class="pre">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <p class="mb-0 font-weight-bold">Nomer Rekening:</p>
                    @if ($bank)
                ...
                <div class="col-lg-4">
                    ...
                    @if ($bank)
                    <input type="text" class="form-control-plaintext bank-ownername" value="{{ sembunyikan_text($bank->pivot->name, 3) }}" readonly>
                    @endif
                </div>
                <div class="col mt-3">
                    @if ($bank)
