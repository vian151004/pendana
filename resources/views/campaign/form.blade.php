<x-modal size="modal-xl" data-backdrop="static" data-keyboard="false">
    ...
    <div class="form-group">
        <label for="short-description">Deskripsi singkat</label>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="input-group datetimepicker" id="publish_date" data-target-input="nearest">
                    <input type="text" name="publish-date" class="form-control datetimepicker-input" data-target="#publish_date" />
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="input-group datetimepicker" id="end_date" data-target-input="nearest">
                    <input type="text" name="end-date" class="form-control datetimepicker-input" data-target="#end_date" />
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" name="receiver" value="" class="custom-control-input" id="saya">
